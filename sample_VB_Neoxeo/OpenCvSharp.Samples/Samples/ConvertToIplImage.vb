...
Namespace OpenCvSharpSamples
    ...
    Friend Module ConvertToIplImage
        ...
        Private Sub TestBitmap()
            Using bitmap As New Bitmap([Const].ImageFruits)
        ...
        Private Sub TestWriteableBitmap()
            ...
            Dim decoder As New PngBitmapDecoder(New Uri([Const].Image16bit, UriKind.Relative), BitmapCreateOptions.PreservePixelFormat, BitmapCacheOption.Default)
        ...
        Private Sub TestWriteableBitmapBgr32()
            ' loads color image
            Dim decoder As New PngBitmapDecoder(New Uri([Const].ImageLenna, UriKind.Relative), BitmapCreateOptions.PreservePixelFormat, BitmapCacheOption.Default)
            Dim bs As BitmapSource = decoder.Frames(0)
