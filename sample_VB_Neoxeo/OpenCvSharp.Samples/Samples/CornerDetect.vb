...
Namespace OpenCvSharpSamples
    ...
    Friend Module CornerDetect
        Public Sub Start()
            ...
            Using dstImg1 As New IplImage([Const].ImageLenna, LoadMode.AnyColor Or LoadMode.AnyDepth)
                Using dstImg2 As IplImage = dstImg1.Clone()
                    Using srcImgGray As New IplImage([Const].ImageLenna, LoadMode.GrayScale)
