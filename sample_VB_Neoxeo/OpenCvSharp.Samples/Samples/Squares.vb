...
Namespace OpenCvSharpSamples
    ...
    Friend Module Squares
        ...
        Private ReadOnly _names() As String = {[Const].ImageSquare1, [Const].ImageSquare2, [Const].ImageSquare3, [Const].ImageSquare4, [Const].ImageSquare5, [Const].ImageSquare6}
        ...
        Public Sub Start()
            ...
            For i As Integer = 0 To _names.Length - 1
                ' load i-th image
                Using img As New IplImage(_names(i), LoadMode.Color)
