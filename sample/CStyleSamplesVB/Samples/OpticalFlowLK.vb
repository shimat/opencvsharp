...
' Namespace OpenCvSharpSamplesVB
    ...
    Friend Module OpticalFlowLK
        Public Sub Start()
            Using srcImg1 As IplImage = Cv.LoadImage([Const].ImagePenguin1, LoadMode.GrayScale)
                Using srcImg2 As IplImage = Cv.LoadImage([Const].ImagePenguin1b, LoadMode.GrayScale)
                    Using dstImg As IplImage = Cv.LoadImage([Const].ImagePenguin1b, LoadMode.Color)
