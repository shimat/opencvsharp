...
' Namespace OpenCvSharpSamplesVB
    ...
    Friend Module OpticalFlowBM
        Public Sub Start()
            ...
            Using srcPrev As IplImage = Cv.LoadImage([Const].ImagePenguin1, LoadMode.GrayScale)
                Using srcCurr As IplImage = Cv.LoadImage([Const].ImagePenguin2, LoadMode.GrayScale)
                    Using dst As IplImage = Cv.LoadImage([Const].ImagePenguin2, LoadMode.Color)
                        ' (1)速度ベクトルを格納する構造体の確保  
