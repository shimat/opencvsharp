...
CVAPI(ExceptionStatus) features2d_Ptr_BRISK_delete(cv::Ptr<cv::xfeatures2d::BRISK> *ptr)
{
    BEGIN_WRAP
    delete ptr;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_Ptr_AgastFeatureDetector_delete(cv::Ptr<cv::xfeatures2d::AgastFeatureDetector> *ptr)
{
    BEGIN_WRAP
    delete ptr;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_setThreshold(cv::xfeatures2d::AgastFeatureDetector *obj, int val)
{
    BEGIN_WRAP
    obj->setThreshold(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_getThreshold(cv::xfeatures2d::AgastFeatureDetector *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getThreshold();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_setNonmaxSuppression(cv::xfeatures2d::AgastFeatureDetector *obj, int val)
{
    BEGIN_WRAP
    obj->setNonmaxSuppression(val != 0);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_getNonmaxSuppression(cv::xfeatures2d::AgastFeatureDetector *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getNonmaxSuppression() ? 1 : 0;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_setType(cv::xfeatures2d::AgastFeatureDetector *obj, int val)
{
    BEGIN_WRAP
    obj->setType(static_cast<cv::xfeatures2d::AgastFeatureDetector::DetectorType>(val));
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AgastFeatureDetector_getType(cv::xfeatures2d::AgastFeatureDetector *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = static_cast<int>(obj->getType());
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_Ptr_KAZE_delete(cv::Ptr<cv::xfeatures2d::KAZE> *ptr)
{
    BEGIN_WRAP
    delete ptr;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setDiffusivity(cv::xfeatures2d::KAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setDiffusivity(static_cast<cv::xfeatures2d::KAZE::DiffusivityType>(val));
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getDiffusivity(cv::xfeatures2d::KAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setExtended(cv::xfeatures2d::KAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setExtended(val != 0);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getExtended(cv::xfeatures2d::KAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setNOctaveLayers(cv::xfeatures2d::KAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setNOctaveLayers(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getNOctaveLayers(cv::xfeatures2d::KAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setNOctaves(cv::xfeatures2d::KAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setNOctaves(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getNOctaves(cv::xfeatures2d::KAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setThreshold(cv::xfeatures2d::KAZE *obj, double val)
{
    BEGIN_WRAP
    obj->setThreshold(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getThreshold(cv::xfeatures2d::KAZE *obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getThreshold();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_KAZE_setUpright(cv::xfeatures2d::KAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setUpright(val != 0);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_KAZE_getUpright(cv::xfeatures2d::KAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_Ptr_AKAZE_delete(cv::Ptr<cv::xfeatures2d::AKAZE> *ptr)
{
    BEGIN_WRAP
    delete ptr;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setDescriptorType(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setDescriptorType(static_cast<cv::xfeatures2d::AKAZE::DescriptorType>(val));
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getDescriptorType(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setDescriptorSize(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setDescriptorSize(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getDescriptorSize(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setDescriptorChannels(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setDescriptorChannels(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getDescriptorChannels(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setThreshold(cv::xfeatures2d::AKAZE *obj, double val)
{
    BEGIN_WRAP
    obj->setThreshold(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getThreshold(cv::xfeatures2d::AKAZE *obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getThreshold();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setNOctaves(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setNOctaves(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getNOctaves(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getNOctaves();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setNOctaveLayers(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setNOctaveLayers(val);
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getNOctaveLayers(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = obj->getNOctaveLayers();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_AKAZE_setDiffusivity(cv::xfeatures2d::AKAZE *obj, int val)
{
    BEGIN_WRAP
    obj->setDiffusivity(static_cast<cv::xfeatures2d::KAZE::DiffusivityType>(val));
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_AKAZE_getDiffusivity(cv::xfeatures2d::AKAZE *obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = static_cast<int>(obj->getDiffusivity());
    END_WRAP
