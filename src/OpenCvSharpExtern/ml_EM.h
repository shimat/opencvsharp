...
CVAPI(ExceptionStatus) ml_EM_getClustersNumber(cv::Ptr<cv::ml::EM>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getClustersNumber();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_EM_setClustersNumber(cv::Ptr<cv::ml::EM>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_EM_getCovarianceMatrixType(cv::Ptr<cv::ml::EM>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getCovarianceMatrixType();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_EM_setCovarianceMatrixType(cv::Ptr<cv::ml::EM>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_EM_getWeights(cv::Ptr<cv::ml::EM>* obj, cv::Mat **returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_EM_getMeans(cv::Ptr<cv::ml::EM>* obj, cv::Mat **returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_EM_getCovs(cv::Ptr<cv::ml::EM>* obj, std::vector<cv::Mat*> *covs)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_EM_predict2(
    cv::Ptr<cv::ml::EM>* obj, cv::_InputArray *sample, cv::_OutputArray *probs, CvVec2d *returnValue)
{
    BEGIN_WRAP
