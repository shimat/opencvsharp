...
CVAPI(ExceptionStatus) ximgproc_FastLineDetector_delete(cv::Ptr<cv::ximgproc::FastLineDetector> *obj)
{
    BEGIN_WRAP
    delete obj;
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_FastLineDetector_detect_OutputArray(cv::ximgproc::FastLineDetector *obj,
...
CVAPI(ExceptionStatus) ximgproc_FastLineDetector_detect_vector(cv::ximgproc::FastLineDetector *obj,
...
CVAPI(ExceptionStatus) ximgproc_FastLineDetector_drawSegments_InputArray(cv::ximgproc::FastLineDetector *obj,
...
CVAPI(ExceptionStatus) ximgproc_FastLineDetector_drawSegments_vector(cv::ximgproc::FastLineDetector *obj,
