...
CVAPI(ExceptionStatus) ml_KNearest_getDefaultK(cv::Ptr<cv::ml::KNearest>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getDefaultK();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_KNearest_setDefaultK(cv::Ptr<cv::ml::KNearest>* obj, int val)
{
    BEGIN_WRAP
    (*obj)->setDefaultK(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_KNearest_getIsClassifier(cv::Ptr<cv::ml::KNearest>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getIsClassifier() ? 1 : 0;
    END_WRAP
}
CVAPI(ExceptionStatus) ml_KNearest_setIsClassifier(cv::Ptr<cv::ml::KNearest>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_KNearest_getEmax(cv::Ptr<cv::ml::KNearest>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getEmax();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_KNearest_setEmax(cv::Ptr<cv::ml::KNearest>* obj, int val)
{
    BEGIN_WRAP
    (*obj)->setEmax(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_KNearest_getAlgorithmType(cv::Ptr<cv::ml::KNearest>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getAlgorithmType();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_KNearest_setAlgorithmType(cv::Ptr<cv::ml::KNearest>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_KNearest_findNearest(cv::Ptr<cv::ml::KNearest>* obj, cv::_InputArray *samples, int k,
