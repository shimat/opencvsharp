...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_add(cv::Ptr<cv::DescriptorMatcher>* obj, cv::Mat **descriptors, int descriptorLength)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_getTrainDescriptors(cv::Ptr<cv::DescriptorMatcher>* obj, std::vector<cv::Mat> *dst)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_clear(cv::Ptr<cv::DescriptorMatcher>* obj)
{
    BEGIN_WRAP
    (*obj)->clear();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_empty(cv::Ptr<cv::DescriptorMatcher>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->empty() ? 1 : 0;
    END_WRAP
}
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_isMaskSupported(cv::Ptr<cv::DescriptorMatcher>* obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_train(cv::Ptr<cv::DescriptorMatcher>* obj)
{
    BEGIN_WRAP
    (*obj)->train();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_match1(
    cv::Ptr<cv::DescriptorMatcher>* obj, cv::Mat *queryDescriptors, 
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_match2(
    cv::Ptr<cv::DescriptorMatcher>* obj, cv::Mat *queryDescriptors, std::vector<cv::DMatch> *matches,
...
CVAPI(ExceptionStatus) features2d_DescriptorMatcher_knnMatch2(
    cv::Ptr<cv::DescriptorMatcher>* obj, cv::Mat *queryDescriptors, std::vector<std::vector<cv::DMatch> > *matches, 
...
CVAPI(ExceptionStatus) features2d_BFMatcher_delete(cv::Ptr<cv::BFMatcher>* obj)
{
    BEGIN_WRAP
    delete obj;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_BFMatcher_isMaskSupported(cv::Ptr<cv::BFMatcher>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->isMaskSupported() ? 1 : 0;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_FlannBasedMatcher_delete(cv::Ptr<cv::FlannBasedMatcher>* obj)
{
    BEGIN_WRAP
    delete obj;
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_FlannBasedMatcher_add(
    cv::Ptr<cv::FlannBasedMatcher>* obj, cv::Mat **descriptors, int descriptorsSize)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) features2d_FlannBasedMatcher_clear(cv::Ptr<cv::FlannBasedMatcher>* obj)
{
    BEGIN_WRAP
    (*obj)->clear();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_FlannBasedMatcher_train(cv::Ptr<cv::FlannBasedMatcher>* obj)
{
    BEGIN_WRAP
    (*obj)->train();
    END_WRAP
...
CVAPI(ExceptionStatus) features2d_FlannBasedMatcher_isMaskSupported(cv::Ptr<cv::FlannBasedMatcher>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->isMaskSupported() ? 1 : 0;
    END_WRAP
