...
CVAPI(ExceptionStatus) ml_SVM_getType(cv::Ptr<cv::ml::SVM>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getType();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setType(cv::Ptr<cv::ml::SVM>* obj, int val)
{
    BEGIN_WRAP
    (*obj)->setType(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getGamma(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getGamma();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setGamma(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setGamma(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getCoef0(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getCoef0();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setCoef0(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setCoef0(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getDegree(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getDegree();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setDegree(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setDegree(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getC(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getC();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setC(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setC(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getP(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getP();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setP(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setP(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getNu(cv::Ptr<cv::ml::SVM>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getNu();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_SVM_setNu(cv::Ptr<cv::ml::SVM>* obj, double val)
{
    BEGIN_WRAP
    (*obj)->setNu(val);
    END_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getKernelType(cv::Ptr<cv::ml::SVM>* obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_setKernel(cv::Ptr<cv::ml::SVM>* obj, int kernelType)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_SVM_getDecisionFunction(
    cv::Ptr<cv::ml::SVM>* obj, int i, cv::_OutputArray *alpha, cv::_OutputArray *svidx, double *returnValue)
{
    BEGIN_WRAP
