...
CVAPI(double) superres_SuperResolution_getLambda(cv::superres::SuperResolution *obj) { return obj->getLambda(); } // TODO typo!
CVAPI(void) superres_SuperResolution_setLambda(cv::superres::SuperResolution *obj, double val) { obj->setLambda(val); } // TODO typo!
