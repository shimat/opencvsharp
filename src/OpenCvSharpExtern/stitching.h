...
CVAPI(ExceptionStatus) stitching_Stitcher_registrationResol(cv::Ptr<cv::Stitcher>* obj, double *returnValue)
{ 
    BEGIN_WRAP
    *returnValue = (*obj)->registrationResol();
    END_WRAP
}
CVAPI(ExceptionStatus) stitching_Stitcher_setRegistrationResol(cv::Ptr<cv::Stitcher>* obj, const double resol_mpx)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_seamEstimationResol(cv::Ptr<cv::Stitcher>* obj, double *returnValue) 
{
    BEGIN_WRAP
    *returnValue = (*obj)->seamEstimationResol();
    END_WRAP
}
CVAPI(ExceptionStatus) stitching_Stitcher_setSeamEstimationResol(cv::Ptr<cv::Stitcher>* obj, const double resol_mpx)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_compositingResol(cv::Ptr<cv::Stitcher>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->compositingResol();
    END_WRAP
}
CVAPI(ExceptionStatus) stitching_Stitcher_setCompositingResol(cv::Ptr<cv::Stitcher>* obj, const double resol_mpx)
{ 
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_panoConfidenceThresh(cv::Ptr<cv::Stitcher>* obj, double *returnValue) 
{ 
    BEGIN_WRAP
    *returnValue = (*obj)->panoConfidenceThresh();
    END_WRAP
}
CVAPI(ExceptionStatus) stitching_Stitcher_setPanoConfidenceThresh(cv::Ptr<cv::Stitcher>* obj, const double conf_thresh)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_waveCorrection(cv::Ptr<cv::Stitcher>* obj, int *returnValue) 
{ 
    BEGIN_WRAP
    *returnValue = (*obj)->waveCorrection() ? 1 : 0; 
    END_WRAP
}
CVAPI(ExceptionStatus) stitching_Stitcher_setWaveCorrection(cv::Ptr<cv::Stitcher>* obj, const int flag)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_estimateTransform_InputArray2(
    cv::Ptr<cv::Stitcher>* obj, cv::_InputArray *images,
...
CVAPI(ExceptionStatus) stitching_Stitcher_estimateTransform_MatArray1(
    cv::Ptr<cv::Stitcher>* obj, const cv::Mat **images, const int imagesSize, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_estimateTransform_MatArray2(
    cv::Ptr<cv::Stitcher>* obj, const cv::Mat **images, const int imagesSize,
    const CvRect **rois, const int roisSize1, const int *roisSize2, int *returnValue)
{
    BEGIN_WRAP
    std::vector<cv::Mat> imagesVec;
...
CVAPI(ExceptionStatus) stitching_Stitcher_component(cv::Ptr<cv::Stitcher>* obj, std::vector<int>* returnValue) 
{ 
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) stitching_Stitcher_workScale(cv::Ptr<cv::Stitcher>* obj, double *returnValue)
{
    BEGIN_WRAP
