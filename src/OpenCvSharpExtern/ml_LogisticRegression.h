...
CVAPI(ExceptionStatus) ml_LogisticRegression_getLearningRate(cv::Ptr<cv::ml::LogisticRegression>* obj, double *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getLearningRate();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_LogisticRegression_setLearningRate(cv::Ptr<cv::ml::LogisticRegression>* obj, double val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_LogisticRegression_getIterations(cv::Ptr<cv::ml::LogisticRegression>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getIterations();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_LogisticRegression_setIterations(cv::Ptr<cv::ml::LogisticRegression>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_LogisticRegression_getRegularization(cv::Ptr<cv::ml::LogisticRegression>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getRegularization();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_LogisticRegression_setRegularization(cv::Ptr<cv::ml::LogisticRegression>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_LogisticRegression_getTrainMethod(cv::Ptr<cv::ml::LogisticRegression>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getTrainMethod();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_LogisticRegression_setTrainMethod(cv::Ptr<cv::ml::LogisticRegression>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_LogisticRegression_getMiniBatchSize(cv::Ptr<cv::ml::LogisticRegression>* obj, int *returnValue)
{
    BEGIN_WRAP
    *returnValue = (*obj)->getMiniBatchSize();
    END_WRAP
}
CVAPI(ExceptionStatus) ml_LogisticRegression_setMiniBatchSize(cv::Ptr<cv::ml::LogisticRegression>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ml_LogisticRegression_predict(
    cv::Ptr<cv::ml::LogisticRegression>* obj, cv::_InputArray *samples, cv::_OutputArray *results, int flags, float *returnValue)
{ 
    BEGIN_WRAP
