...
CVAPI(ExceptionStatus) shape_ShapeDistanceExtractor_computeDistance(
    cv::Ptr<cv::ShapeDistanceExtractor>* obj, cv::_InputArray *contour1, cv::_InputArray *contour2, float *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_setAngularBins(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_getAngularBins(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_setInnerRadius(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, float val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_getInnerRadius(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, float *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_setImages(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, cv::_InputArray *image1, cv::_InputArray *image2)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_ShapeContextDistanceExtractor_getImages(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, cv::_OutputArray *image1, cv::_OutputArray *image2)
{
    BEGIN_WRAP
...
/*CVAPI(void) shape_ShapeContextDistanceExtractor_setCostExtractor(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, Ptr<HistogramCostExtractor> comparer)
{
...
/*CVAPI(void) shape_ShapeContextDistanceExtractor_setTransformAlgorithm(
    cv::Ptr<cv::ShapeContextDistanceExtractor>* obj, Ptr<ShapeTransformer> transformer)
{
}*/
...
CVAPI(ExceptionStatus) shape_HausdorffDistanceExtractor_setDistanceFlag(
    cv::Ptr<cv::HausdorffDistanceExtractor>* obj, int val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_HausdorffDistanceExtractor_getDistanceFlag(
    cv::Ptr<cv::HausdorffDistanceExtractor>* obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_HausdorffDistanceExtractor_setRankProportion(
    cv::Ptr<cv::HausdorffDistanceExtractor>* obj, float val)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) shape_HausdorffDistanceExtractor_getRankProportion(
    cv::Ptr<cv::HausdorffDistanceExtractor>* obj, float *returnValue)
{
    BEGIN_WRAP
