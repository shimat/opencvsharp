...
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_processImage(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, cv::_InputArray *src, cv::_OutputArray *dst)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_setSigma(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, double value)
{
    BEGIN_WRAP
    (*obj)->setSigma(value);
    END_WRAP
}
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_getSigma(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, double *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_setK(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, float value)
{
    BEGIN_WRAP
    (*obj)->setK(value);
    END_WRAP
}
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_getK(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, float *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_setMinSize(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, int value)
{
    BEGIN_WRAP
    (*obj)->setMinSize(value);
    END_WRAP
}
CVAPI(ExceptionStatus) ximgproc_segmentation_GraphSegmentation_getMinSize(cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation>* obj, int *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentationStrategy_setImage(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategy>* obj, cv::_InputArray *img, cv::_InputArray *regions, cv::_InputArray *sizes, int image_id)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentationStrategy_get(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategy>* obj, int r1, int r2, float *returnValue)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentationStrategy_merge(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategy>* obj, int r1, int r2)
{
    BEGIN_WRAP
    (*obj)->merge(r1, r2);
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentationStrategyMultiple_addStrategy(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyMultiple>* obj, cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategy> *g, float weight)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentationStrategyMultiple_clearStrategies(cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategyMultiple>* obj)
{
    BEGIN_WRAP
    (*obj)->clearStrategies();
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_setBaseImage(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, cv::_InputArray *img)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_switchToSingleStrategy(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, int k, float sigma)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_switchToSelectiveSearchFast(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, int base_k, int inc_k, float sigma)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_addImage(cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, cv::_InputArray *img)
{
    BEGIN_WRAP
    (*obj)->addImage(*img);
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_clearImages(cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj)
{
    BEGIN_WRAP
    (*obj)->clearImages();
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_addGraphSegmentation(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, cv::Ptr<cv::ximgproc::segmentation::GraphSegmentation> *g)
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_clearGraphSegmentations(cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj) 
{
    BEGIN_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_addStrategy(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentationStrategy> *s)
{
    BEGIN_WRAP
    (*obj)->addStrategy(*s);
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_clearStrategies(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj) 
{
    BEGIN_WRAP
    (*obj)->clearStrategies();
    END_WRAP
...
CVAPI(ExceptionStatus) ximgproc_segmentation_SelectiveSearchSegmentation_process(
    cv::Ptr<cv::ximgproc::segmentation::SelectiveSearchSegmentation>* obj, std::vector<cv::Rect> *rects) 
{
    BEGIN_WRAP
    (*obj)->process(*rects);
    END_WRAP
