...
CVAPI(ExceptionStatus) imgproc_getDerivKernels(const interop::OutputArrayProxy* kx, const interop::OutputArrayProxy* ky,
...
CVAPI(ExceptionStatus) imgproc_medianBlur(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ksize)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_GaussianBlur(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_bilateralFilter(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_boxFilter(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
...
CVAPI(ExceptionStatus) imgproc_sqrBoxFilter(
    const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
    interop::Size ksize, interop::Point anchor, int normalize, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_blur(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, interop::Size ksize, interop::Point anchor, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_filter2D(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
                             const interop::InputArrayProxy* kernel, interop::Point anchor, double delta, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_filter2Dp(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* kernel,
...
CVAPI(ExceptionStatus) imgproc_sepFilter2D(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
                                const interop::InputArrayProxy* kernelX, const interop::InputArrayProxy* kernelY,
...
CVAPI(ExceptionStatus) imgproc_Sobel(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
...
CVAPI(ExceptionStatus) imgproc_spatialGradient(
    const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dx, const interop::OutputArrayProxy* dy, int ksize, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_Scharr(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
...
CVAPI(ExceptionStatus) imgproc_Laplacian(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ddepth,
...
CVAPI(ExceptionStatus) imgproc_Canny1(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* edges,
...
CVAPI(ExceptionStatus) imgproc_Canny2(
    const interop::InputArrayProxy* dx, const interop::InputArrayProxy* dy, const interop::OutputArrayProxy* edges,
...
CVAPI(ExceptionStatus) imgproc_cornerMinEigenVal(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_cornerHarris(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_cornerEigenValsAndVecs(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
                                           int blockSize, int ksize, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_preCornerDetect(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int ksize, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_cornerSubPix(const interop::InputArrayProxy* image, std::vector<cv::Point2f> *corners,
...
CVAPI(ExceptionStatus) imgproc_goodFeaturesToTrack(const interop::InputArrayProxy* src, std::vector<cv::Point2f> *corners,
                                        int maxCorners, double qualityLevel, double minDistance,
                                        const interop::InputArrayProxy* mask, int blockSize, int useHarrisDetector, double k)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_HoughLines(const interop::InputArrayProxy* src, std::vector<cv::Vec2f> *lines,
...
CVAPI(ExceptionStatus) imgproc_HoughLinesP(const interop::InputArrayProxy* src, std::vector<cv::Vec4i> *lines,
                                double rho, double theta, int threshold,
...
CVAPI(ExceptionStatus) imgproc_HoughLinesPointSet(
    const interop::InputArrayProxy* _point, const interop::OutputArrayProxy* _lines, int lines_max, int threshold,
...
CVAPI(ExceptionStatus) imgproc_HoughCircles(const interop::InputArrayProxy* src, std::vector<cv::Vec3f> *circles,
...
CVAPI(ExceptionStatus) imgproc_erode(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* kernel,
...
CVAPI(ExceptionStatus) imgproc_dilate(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* kernel,
                           interop::Point anchor, int iterations, int borderType, interop::Scalar borderValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_morphologyEx(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int op, const interop::InputArrayProxy* kernel,
                                 interop::Point anchor, int iterations, int borderType, interop::Scalar borderValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_resize(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, interop::Size dsize, double fx, double fy, int interpolation)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_warpAffine(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* M, interop::Size dsize,
...
CVAPI(ExceptionStatus) imgproc_warpPerspective_MisInputArray(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* m, interop::Size dsize,
                                                             int flags, int borderMode, interop::Scalar borderValue, int hint)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_warpPerspective_MisArray(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, float* m, int mRow, int mCol, interop::Size dsize,
                                                        int flags, int borderMode, interop::Scalar borderValue, int hint)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_remap(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* map1, const interop::InputArrayProxy* map2,
...
CVAPI(ExceptionStatus) imgproc_convertMaps(const interop::InputArrayProxy* map1, const interop::InputArrayProxy* map2, const interop::OutputArrayProxy* dstmap1, const interop::OutputArrayProxy* dstmap2,
...
CVAPI(ExceptionStatus) imgproc_getPerspectiveTransform2(const interop::InputArrayProxy* src, const interop::InputArrayProxy* dst, cv::Mat** returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_getAffineTransform2(const interop::InputArrayProxy* src, const interop::InputArrayProxy* dst, cv::Mat** returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_getRectSubPix(const interop::InputArrayProxy* image, interop::Size patchSize, interop::Point2f center, const interop::OutputArrayProxy* patch, int patchType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_warpPolar(
    const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, interop::Size dsize,
...
CVAPI(ExceptionStatus) imgproc_integral1(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* sum, int sdepth)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_integral2(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* sum, const interop::OutputArrayProxy* sqsum, int sdepth)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_integral3(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* sum, const interop::OutputArrayProxy* sqsum, const interop::OutputArrayProxy* tilted, int sdepth, int sqdepth)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_accumulate(const interop::InputArrayProxy* src, const interop::InputOutputArrayProxy* dst, const interop::InputArrayProxy* mask)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_accumulateSquare(const interop::InputArrayProxy* src, const interop::InputOutputArrayProxy* dst, const interop::InputArrayProxy* mask)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_accumulateProduct(const interop::InputArrayProxy* src1, const interop::InputArrayProxy* src2, const interop::InputOutputArrayProxy* dst, const interop::InputArrayProxy* mask)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_accumulateWeighted(const interop::InputArrayProxy* src, const interop::InputOutputArrayProxy* dst, double alpha, const interop::InputArrayProxy* mask)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_phaseCorrelate(const interop::InputArrayProxy* src1, const interop::InputArrayProxy* src2,
                                              const interop::InputArrayProxy* window, double* response, interop::Point2d* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_createHanningWindow(const interop::OutputArrayProxy* dst, interop::Size winSize, int type)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_threshold(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_adaptiveThreshold(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_pyrDown(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, interop::Size dstSize, int borderType)
{
    return cvTry([&] {
        cv::pyrDown(InProxy(*src), OutProxy(*dst), cpp(dstSize), borderType);
    });
}
CVAPI(ExceptionStatus) imgproc_pyrUp(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, interop::Size dstSize, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_buildPyramid(const interop::InputArrayProxy* src, std::vector<cv::Mat> *dst,int maxlevel, int borderType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_calcHist(cv::Mat **images, int nimages,
                              const int* channels, const interop::InputArrayProxy* mask,
                              const interop::OutputArrayProxy* hist, int dims, const int* histSize,
...
CVAPI(ExceptionStatus) imgproc_calcBackProject(cv::Mat **images, int nimages,
                                    const int* channels, const interop::InputArrayProxy* hist, const interop::OutputArrayProxy* backProject, 
...
CVAPI(ExceptionStatus) imgproc_compareHist(const interop::InputArrayProxy* h1, const interop::InputArrayProxy* h2, int method, double *returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_EMD(const interop::InputArrayProxy* signature1, const interop::InputArrayProxy* signature2,
                         int distType, const interop::InputArrayProxy* cost, float* lowerBound, const interop::OutputArrayProxy* flow, float* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_pyrMeanShiftFiltering(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_grabCut(const interop::InputArrayProxy* img, const interop::InputOutputArrayProxy* mask, interop::Rect rect,
                            const interop::InputOutputArrayProxy* bgdModel, const interop::InputOutputArrayProxy* fgdModel,
...
CVAPI(ExceptionStatus) imgproc_distanceTransformWithLabels(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
                                                const interop::OutputArrayProxy* labels, int distanceType, int maskSize,
                                                int labelType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_distanceTransform(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst,
...
CVAPI(ExceptionStatus) imgproc_floodFill1(const interop::InputOutputArrayProxy* image,
...
CVAPI(ExceptionStatus) imgproc_floodFill2(const interop::InputOutputArrayProxy* image, const interop::InputOutputArrayProxy* mask,
                              interop::Point seedPoint, interop::Scalar newVal, interop::Rect *rect,
                              interop::Scalar loDiff, interop::Scalar upDiff, int flags, int* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_blendLinear(
    const interop::InputArrayProxy* src1, const interop::InputArrayProxy* src2, const interop::InputArrayProxy* weights1, const interop::InputArrayProxy* weights2, const interop::OutputArrayProxy* dst)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_cvtColor(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int code, int dstCn, int hint)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_cvtColorTwoPlane(const interop::InputArrayProxy* src1, const interop::InputArrayProxy* src2, const interop::OutputArrayProxy* dst, int code, int hint)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_demosaicing(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int code, int dstCn)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_moments(const interop::InputArrayProxy* arr, int binaryImage, interop::Moments *returnValue)
{
    return cvTry([&] {
...
*/
CVAPI(ExceptionStatus) imgproc_matchTemplate(const interop::InputArrayProxy* image, const interop::InputArrayProxy* templ,
                                  const interop::OutputArrayProxy* result, int method, const interop::InputArrayProxy* mask)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_connectedComponentsWithAlgorithm(
    const interop::InputArrayProxy* image, const interop::OutputArrayProxy* labels, int connectivity, int ltype, int ccltype, int* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_connectedComponents(const interop::InputArrayProxy* image, const interop::OutputArrayProxy* labels,
...
CVAPI(ExceptionStatus) imgproc_connectedComponentsWithStatsWithAlgorithm(
    const interop::InputArrayProxy* image, const interop::OutputArrayProxy* labels,
...
CVAPI(ExceptionStatus) imgproc_connectedComponentsWithStats(const interop::InputArrayProxy* image, const interop::OutputArrayProxy* labels,
                                                const interop::OutputArrayProxy* stats, const interop::OutputArrayProxy* centroids, int connectivity, int ltype, int* returnValue)
{
    return cvTry([&] {
        *returnValue = cv::connectedComponentsWithStats(
...
CVAPI(ExceptionStatus) imgproc_findContours1_vector(const interop::InputArrayProxy* image, std::vector<std::vector<cv::Point> > *contours,
...
CVAPI(ExceptionStatus) imgproc_findContours1_OutputArray(const interop::InputArrayProxy* image, std::vector<cv::Mat> *contours,
                                              const interop::OutputArrayProxy* hierarchy, int mode, int method, interop::Point offset)
{
    return cvTry([&] {
        cv::findContours(InProxy(*image), *contours, OutProxy(*hierarchy), mode, method, cpp(offset));
    });
}
CVAPI(ExceptionStatus) imgproc_findContours2_vector(const interop::InputArrayProxy* image, std::vector<std::vector<cv::Point> > *contours,
...
CVAPI(ExceptionStatus) imgproc_findContours2_OutputArray(const interop::InputArrayProxy* image, std::vector<cv::Mat> *contours,
                                              int mode, int method, interop::Point offset)
{
    return cvTry([&] {
        cv::findContours(InProxy(*image), *contours, mode, method, cpp(offset));
...
CVAPI(ExceptionStatus) imgproc_findContoursLinkRuns1(const interop::InputArrayProxy* image,
...
CVAPI(ExceptionStatus) imgproc_approxPolyDP_InputArray(const interop::InputArrayProxy* curve, const interop::OutputArrayProxy* approxCurve, double epsilon, int closed)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_arcLength_InputArray(const interop::InputArrayProxy* curve, int closed, double *returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_contourArea_InputArray(const interop::InputArrayProxy* contour, int oriented, double* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_minEnclosingCircle_InputArray(const interop::InputArrayProxy* points, interop::Point2f *center, float *radius)
{
    return cvTry([&] {
        cv::Point2f center0;
        float radius0;
...
CVAPI(ExceptionStatus) imgproc_minEnclosingTriangle_InputOutputArray(const interop::InputArrayProxy* points, const interop::OutputArrayProxy* triangle, double *returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_matchShapes_InputArray(
    const interop::InputArrayProxy* contour1, const interop::InputArrayProxy* contour2, int method, double parameter, double* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_convexHull_InputArray(const interop::InputArrayProxy* points, const interop::OutputArrayProxy* hull, int clockwise, int returnPoints)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_convexityDefects_InputArray(const interop::InputArrayProxy* contour, const interop::InputArrayProxy* convexHull,
...
CVAPI(ExceptionStatus) imgproc_intersectConvexConvex_InputArray(const interop::InputArrayProxy* p1, const interop::InputArrayProxy* p2,
                                                      const interop::OutputArrayProxy* p12, int handleNested, float* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_fitLine_InputArray(const interop::InputArrayProxy* points, const interop::OutputArrayProxy* line,
...
CVAPI(ExceptionStatus) imgproc_pointPolygonTest_InputArray(
    const interop::InputArrayProxy* contour, interop::Point2f pt, int measureDist, double *returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_rotatedRectangleIntersection_OutputArray(
    interop::RotatedRect rect1, interop::RotatedRect rect2, const interop::OutputArrayProxy* intersectingRegion, int* returnValue)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_applyColorMap1(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, int colorMap)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_applyColorMap2(const interop::InputArrayProxy* src, const interop::OutputArrayProxy* dst, const interop::InputArrayProxy* userColor)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_line(
    const interop::InputOutputArrayProxy* img, interop::Point pt1, interop::Point pt2, interop::Scalar color,
...
CVAPI(ExceptionStatus) imgproc_rectangle_InputOutputArray_Point(
    const interop::InputOutputArrayProxy* img, interop::Point pt1, interop::Point pt2,
...
CVAPI(ExceptionStatus) imgproc_rectangle_InputOutputArray_Rect(
    const interop::InputOutputArrayProxy* img, interop::Rect rect,
    interop::Scalar color, int thickness, int lineType, int shift)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_circle(
    const interop::InputOutputArrayProxy* img, interop::Point center, int radius,
    interop::Scalar color, int thickness, int lineType, int shift)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_ellipse1(
    const interop::InputOutputArrayProxy* img, interop::Point center, interop::Size axes,
...
CVAPI(ExceptionStatus) imgproc_ellipse2(
    const interop::InputOutputArrayProxy* img, interop::RotatedRect box, interop::Scalar color, int thickness, int lineType)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_drawMarker(
    const interop::InputOutputArrayProxy* img, interop::Point position, interop::Scalar color,
...
CVAPI(ExceptionStatus) imgproc_fillConvexPoly_InputOutputArray(
    const interop::InputOutputArrayProxy* img, const interop::InputArrayProxy* points, interop::Scalar color, int lineType, int shift)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_fillPoly_InputOutputArray(const interop::InputOutputArrayProxy* img, const interop::InputArrayProxy* pts,
...
CVAPI(ExceptionStatus) imgproc_polylines_InputOutputArray(
    const interop::InputOutputArrayProxy* img, const interop::InputArrayProxy* pts, int isClosed, interop::Scalar color,
    int thickness, int lineType, int shift)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_drawContours_vector(const interop::InputOutputArrayProxy* image,
...
CVAPI(ExceptionStatus) imgproc_drawContours_InputArray(const interop::InputOutputArrayProxy* image,
                                            cv::Mat **contours, int contoursLength,
                                            int contourIdx, interop::Scalar color, int thickness, int lineType,
                                            const interop::InputArrayProxy* hierarchy, int maxLevel, interop::Point offset)
{
    return cvTry([&] {
...
CVAPI(ExceptionStatus) imgproc_putText(const interop::InputOutputArrayProxy* img, const char *text, interop::Point org,
