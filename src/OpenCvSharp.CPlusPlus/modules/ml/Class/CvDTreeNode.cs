    ...
    public class CvDTreeNode : CvObject
    {
		...
		public int ClassIdx
		{
            get
            {
                unsafe
                {
                    return ((WCvDTreeNode*)ptr)->class_idx;
                }
            }
		}
		...
		public CvDTreeNode Parent
		{
			get
			{
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvDTreeNode*)ptr)->parent);
                    if (p == IntPtr.Zero)
                        return null;
		...
		public CvDTreeNode Left
		{
			get
			{
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvDTreeNode*)ptr)->left);
                    if (p == IntPtr.Zero)
                        return null;
                    return new CvDTreeNode(p);
                }
		...
		public CvDTreeNode Right
		{
			get
			{
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvDTreeNode*)ptr)->right);
                    if (p == IntPtr.Zero)
                        return null;
                    return new CvDTreeNode(p);
                }
		...
		public CvDTreeSplit Split
		{
			get
			{
                unsafe
                {
                    IntPtr p = new IntPtr(((WCvDTreeNode*)ptr)->split);
                    if (p == IntPtr.Zero)
                        return null;
                    else
		...
		public int SampleCount
		{
            get
            {
                unsafe
                {
                    return ((WCvDTreeNode*)ptr)->sample_count;
                }
            }
		}
