...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class StereoSGBM : DisposableCvObject
    {
        ...
        public StereoSGBM()
        {
            ptr = CppInvoke.calib3d_StereoSGBM_new1();
            if (ptr == IntPtr.Zero)
        ...
        public int MinDisparity
        {
            get
            {
                ...
                return CppInvoke.calib3d_StereoSGBM_minDisparity_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_minDisparity_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int NumberOfDisparities
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_numberOfDisparities_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_numberOfDisparities_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int SADWindowSize
        {
            get
            {
                ...
                return CppInvoke.calib3d_StereoSGBM_SADWindowSize_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_SADWindowSize_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int PreFilterCap
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_preFilterCap_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_preFilterCap_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int UniquenessRatio
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_uniquenessRatio_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_uniquenessRatio_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int P1
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_P1_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_P1_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int P2
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_P2_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_P2_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int SpeckleWindowSize
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_speckleWindowSize_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_speckleWindowSize_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int SpeckleRange
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_speckleRange_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_speckleRange_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public int Disp12MaxDiff
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_disp12MaxDiff_get(ptr);
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_disp12MaxDiff_set(ptr, value);
            }
        }
#if LANG_JP
        /// <summary>
        ...
        public bool FullDP
        {
            get
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                return CppInvoke.calib3d_StereoSGBM_fullDP_get(ptr) != 0;
            }
            set
            {
                if (disposed)
                    throw new ObjectDisposedException("StereoSGBM");
                CppInvoke.calib3d_StereoSGBM_fullDP_set(ptr, value ? 1 : 0);
            }
        }
        #endregion
