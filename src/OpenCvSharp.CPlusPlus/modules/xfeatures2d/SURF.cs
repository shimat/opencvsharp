...
namespace OpenCvSharp.CPlusPlus.XFeatures2D
{
    ...
    /// </summary>
        ...
        public SURF()
            : base()
        {
            ptr = NativeMethods.xfeatures2d_SURF_new1();
            detectorPtr = null;
        }
        ...
        public SURF(double hessianThreshold,
            ...
            : base()
        {
            ptr = NativeMethods.xfeatures2d_SURF_new2(hessianThreshold, nOctaves, nOctaveLayers,
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                try
                {
                    ...
                    {
                        NativeMethods.xfeatures2d_SURF_delete(ptr);
                    }
                    detectorPtr = null;
                    ptr = IntPtr.Zero;
                    disposed = true;
        ...
        public int DescriptorSize
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_descriptorSize(ptr);
            }
        }
        ...
        public int DescriptorType
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_descriptorType(ptr);
            }
        }
        ...
        public double HessianThreshold
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_hessianThreshold_get(ptr);
            }
            set
            {
                ThrowIfDisposed();
                NativeMethods.xfeatures2d_SURF_hessianThreshold_set(ptr, value);
            }
        }
        /// <summary>
        ...
        public int NOctaves
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_nOctaves_get(ptr);
            }
            set
            {
                ThrowIfDisposed();
                NativeMethods.xfeatures2d_SURF_nOctaves_set(ptr, value);
            }
        }
        /// <summary>
        ...
        public int NOctaveLayers
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_nOctaveLayers_get(ptr);
            }
            set
            {
                ThrowIfDisposed();
                NativeMethods.xfeatures2d_SURF_nOctaveLayers_set(ptr, value);
            }
        }
        /// <summary>
        ...
        public bool Extended
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_extended_get(ptr) != 0;
            }
            set
            {
                ThrowIfDisposed();
                NativeMethods.xfeatures2d_SURF_extended_set(ptr, value ? 1 : 0);
            }
        }
        /// <summary>
        ...
        public bool Upright
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SURF_upright_get(ptr) != 0;
            }
            set
            {
                ThrowIfDisposed();
                NativeMethods.xfeatures2d_SURF_upright_set(ptr, value ? 1 : 0);
            }
        }
        ...
        public KeyPoint[] Run(InputArray img, Mat mask)
        {
            ...
            {
                NativeMethods.xfeatures2d_SURF_run1(ptr, img.CvPtr, Cv2.ToPtr(mask), keypointsVec.CvPtr);
            ...
            bool useProvidedKeypoints = false)
        {
            ...
            {
                NativeMethods.xfeatures2d_SURF_run2_vector(ptr, img.CvPtr, Cv2.ToPtr(mask), keypointsVec.CvPtr,
            ...
            bool useProvidedKeypoints = false)
        {
            ...
            using (VectorOfKeyPoint keypointsVec = new VectorOfKeyPoint())
            {
                NativeMethods.xfeatures2d_SURF_run2_OutputArray(ptr, img.CvPtr, Cv2.ToPtr(mask), keypointsVec.CvPtr,
