...
namespace OpenCvSharp.CPlusPlus.XFeatures2D
{
    ...
    public class SIFT : Feature2D
    {
        ...
        public SIFT(int nFeatures = 0, int nOctaveLayers = 3,
            ...
            : base()
        {
            ptr = NativeMethods.xfeatures2d_SIFT_new(nFeatures, nOctaveLayers, 
        ...
        public static SIFT CreateAlgorithm(string name)
        {
            ...
            IntPtr p = NativeMethods.xfeatures2d_SIFT_createAlgorithm(name);
            if (p == IntPtr.Zero)
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                try
                {
                    ...
                    {
                        NativeMethods.xfeatures2d_SIFT_delete(ptr);
                    }
                    detectorPtr = null;
                    ptr = IntPtr.Zero;
                    disposed = true;
        ...
        public int DescriptorSize
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SIFT_descriptorSize(ptr);
            }
        }
        ...
        public int DescriptorType
        {
            ...
            {
                ThrowIfDisposed();
                return NativeMethods.xfeatures2d_SIFT_descriptorType(ptr);
            }
        }
        ...
        {
            get { return NativeMethods.xfeatures2d_SIFT_info(ptr); }
        }
        #endregion
        ...
        public KeyPoint[] Run(InputArray img, InputArray mask)
        {
            ...
            {
                NativeMethods.xfeatures2d_SIFT_run1(ptr, img.CvPtr, Cv2.ToPtr(mask), keypointsVec.CvPtr);
            ...
            bool useProvidedKeypoints = false)
        {
            ...
            using (VectorOfKeyPoint keypointsVec = new VectorOfKeyPoint())
            {
                NativeMethods.xfeatures2d_SIFT_run2_OutputArray(ptr, img.CvPtr, Cv2.ToPtr(mask), keypointsVec.CvPtr,
        ...
        public Mat[] BuildGaussianPyramid(Mat baseMat, int nOctaves)
        {
            ...
            {
                NativeMethods.xfeatures2d_SIFT_buildGaussianPyramid(ptr, baseMat.CvPtr, pyrVec.CvPtr, nOctaves);
        ...
        public Mat[] BuildDoGPyramid(IEnumerable<Mat> pyr)
        {
            ...
            {
                NativeMethods.xfeatures2d_SIFT_buildDoGPyramid(ptr, pyrPtrs, pyrPtrs.Length, dogPyrVec.CvPtr);
        ...
        public KeyPoint[] FindScaleSpaceExtrema(IEnumerable<Mat> gaussPyr, IEnumerable<Mat> dogPyr)
        {
            ...
            using (VectorOfKeyPoint keyPointsVec = new VectorOfKeyPoint())
            {
                NativeMethods.xfeatures2d_SIFT_findScaleSpaceExtrema(ptr, gaussPyrPtrs, gaussPyrPtrs.Length,
