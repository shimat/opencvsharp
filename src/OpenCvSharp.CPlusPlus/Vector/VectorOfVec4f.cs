...
namespace OpenCvSharp.CPlusPlus
{
    ...
    public class VectorOfVec4f : DisposableCvObject, IStdVector<Vec4f>
    {
        ...
        public VectorOfVec4f(int size)
        {
            ...
            ptr = CppInvoke.vector_Vec4f_new2(new IntPtr(size));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public VectorOfVec4f(IEnumerable<Vec4f> data)
        {
            ...
            ptr = CppInvoke.vector_Vec4f_new3(array, new IntPtr(array.Length));
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                try
                {
                    if (IsEnabledDispose)
                    {
                        CppInvoke.vector_Vec4f_delete(ptr);
                    }
                    disposed = true;
                }
                finally
        ...
        public int Size
        {
            get { return CppInvoke.vector_Vec4f_getSize(ptr).ToInt32(); }
        }
        /// <summary>
        /// &amp;vector[0]
        /// </summary>
        ...
        {
            get { return CppInvoke.vector_Vec4f_getPointer(ptr); }
        }
        #endregion
