...
namespace OpenCvSharp.MachineLearning
{
    ...
    public class CvBoostParams : CvDTreeParams
    {
        ...
        {
            ptr = MLInvoke.CvBoostParams_construct_default();
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                ...
                try
                {
                    ...
                    if (IsEnabledDispose)
                    {
                        MLInvoke.CvBoostParams_destruct(ptr);
                    }
                    disposed = true;
                }
                finally
        ...
        {
            get { return (BoostType)MLInvoke.CvBoostParams_boost_type_get(ptr); }
            set { MLInvoke.CvBoostParams_boost_type_set(ptr, (int)value); }
        }
#if LANG_JP
        /// <summary>
        /// 構築する弱い分類器の個数． 
        ...
        {
            get { return MLInvoke.CvBoostParams_weak_count_get(ptr); }
            set { MLInvoke.CvBoostParams_weak_count_set(ptr, value); }
        }
#if LANG_JP
        /// <summary>
        ...
        {
            get { return (BoostSplitCriteria)MLInvoke.CvBoostParams_split_criteria_get(ptr); }
            set { MLInvoke.CvBoostParams_split_criteria_set(ptr, (int)value); }
        }
#if LANG_JP
        /// <summary>
        /// トリミング重み比率．0..1 の範囲内．
        ...
        {
            get { return MLInvoke.CvBoostParams_weight_trim_rate_get(ptr); }
            set { MLInvoke.CvBoostParams_weight_trim_rate_set(ptr, value); }
        }
        #endregion
    }
}
