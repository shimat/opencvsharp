...
namespace OpenCvSharp.MachineLearning
{
    ...
    public class CvDTreeParams : DisposableCvObject
    {
        ...
        {					
            ...
            ptr = MLInvoke.CvDTreeParams_construct(max_depth, min_sample_count, regression_accuracy, use_surrogates, max_categories, 
        ...
        public float[] Priors
        {
            ...
            { 
                ...
                if (value != null)
                {
                    ...
                    unsafe
                    {
                        MLInvoke.CvDTreeParams_priors_set(ptr, (float*)_handle.AddrOfPinnedObject());
                    }
                }
            }
        }
