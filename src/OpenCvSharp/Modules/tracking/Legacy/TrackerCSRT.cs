...
/// <inheritdoc />
/// <summary>
/// The CSRT tracker: Discriminative Correlation Filter with Channel and Spatial Reliability.
/// Mirrors <c>cv::legacy::TrackerCSRT</c> (as opposed to the modern
/// <see cref="OpenCvSharp.Tracking.TrackerCSRT"/>).
/// </summary>
// ReSharper disable once InconsistentNaming
public class TrackerCSRT : LegacyTracker
{
    private TrackerCSRT(IntPtr smartPtr, IntPtr rawPtr)
        : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods.tracking_legacy_Ptr_TrackerCSRT_delete(p)))
    {
    }
    ...
    public static TrackerCSRT Create()
    {
        NativeMethods.HandleException(
            NativeMethods.tracking_legacy_TrackerCSRT_create1(out var smartPtr));
        NativeMethods.HandleException(NativeMethods.tracking_legacy_Ptr_TrackerCSRT_get(smartPtr, out var rawPtr));
    ...
    public static TrackerCSRT Create(Params parameters)
    {
        ...
        try
        {
            ...
            NativeMethods.HandleException(
                NativeMethods.tracking_legacy_TrackerCSRT_create2(ref native, out var smartPtr));
            NativeMethods.HandleException(NativeMethods.tracking_legacy_Ptr_TrackerCSRT_get(smartPtr, out var rawPtr));
            return new TrackerCSRT(smartPtr, rawPtr);
        }
        finally
...
#pragma warning disable CA1034
    ...
    /// the blittable <see cref="WLegacyTrackerCSRTParams"/> mirror passed to the native entry point.
    /// The shape is identical to the modern <see cref="OpenCvSharp.Tracking.TrackerCSRT.Params"/>.
    /// </summary>
...
#pragma warning restore 1591
        ...
        /// </summary>
        internal readonly WLegacyTrackerCSRTParams ToNativeStruct(IntPtr windowFunction) => new()
        {
            UseHog = UseHog ? 1 : 0,
...
/// <summary>
/// Blittable mirror of native <c>tracker_legacy_TrackerCSRT_Params</c> (the use-flags are
/// <c>int</c> and <c>window_function</c> is a <c>char*</c>). Built from
/// <see cref="TrackerCSRT.Params"/> for the P/Invoke.
/// </summary>
#pragma warning disable CA1815
[StructLayout(LayoutKind.Sequential)]
[SuppressMessage("Design", "CA1051: Do not declare visible instance fields")]
public struct WLegacyTrackerCSRTParams
{
#pragma warning disable 1591
    public int UseHog;
