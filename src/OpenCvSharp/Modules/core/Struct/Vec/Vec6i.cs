...
namespace OpenCvSharp
{
    ...
    public struct Vec6i : IVec<int>, IEquatable<Vec6i>
    {
        ...
        public void Deconstruct(out int item0, out int item1, out int item2, out int item3, out int item4, out int item5) => (item0, item1, item2, item3, item4, item5) = (Item0, Item1, Item2, Item3, Item4, Item5);
#endif
