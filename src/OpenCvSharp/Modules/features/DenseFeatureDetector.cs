...
namespace OpenCvSharp
{
    ...
    public class DenseFeatureDetector : FeatureDetector
    {
        ...
        {
            ptr = NativeMethods.features_DenseFeatureDetector_new(
        ...
        protected override void Dispose(bool disposing)
        {
            if (!disposed)
            {
                try
                {
                    ...
                    {
                        if (ptr != IntPtr.Zero)
                            NativeMethods.features_DenseFeatureDetector_delete(CvPtr);
                        ptr = IntPtr.Zero;
                    }
                    disposed = true;
                }
        ...
        public override IntPtr InfoPtr
        {
            get
            {
                return NativeMethods.features_DenseFeatureDetector_info(CvPtr);
            }
        }
    }
}
