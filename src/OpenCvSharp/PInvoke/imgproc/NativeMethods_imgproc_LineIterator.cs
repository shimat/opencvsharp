...
namespace OpenCvSharp
{
    static partial class NativeMethods
    {
        ...
        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe byte* imgproc_LineIterator_operatorEntity(IntPtr obj);
        ...
        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern int imgproc_LineIterator_ptr_get(IntPtr obj);

        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe void imgproc_LineIterator_ptr_set(IntPtr obj, byte* val);

        [DllImport(DllExtern, CallingConvention = CallingConvention.Cdecl)]
        public static extern int imgproc_LineIterator_ptr0_get(IntPtr obj);
