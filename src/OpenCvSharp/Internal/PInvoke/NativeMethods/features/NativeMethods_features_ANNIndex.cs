...
static partial class NativeMethods
{
    ...
    [LibraryImport(DllExtern, EntryPoint = "features_ANNIndex_save")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(DllExtern, EntryPoint = "features_ANNIndex_load")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    ...
    [LibraryImport(DllExtern, EntryPoint = "features_ANNIndex_setOnDiskBuild")]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
