    ...
    public partial class StereoBM_GPU : DisposableCvObject
    {
        ...
        public int Preset
        {
            get
            {
                ...
                unsafe
                {
                    return *GpuInvoke.StereoBM_GPU_preset(ptr);
                }
            }
            set
            {
                ...
                unsafe
                {
                    *GpuInvoke.StereoBM_GPU_preset(ptr) = value;
                }
            }
        }
#if LANG_JP
        ...
        public int Ndisp
        {
            get
            {
                ...
                unsafe
                {
                    return *GpuInvoke.StereoBM_GPU_ndisp(ptr);
                }
            }
            set
            {
                ...
                unsafe
                {
                    *GpuInvoke.StereoBM_GPU_ndisp(ptr) = value;
                }
            }
        }
#if LANG_JP
        ...
        public int WinSize
        {
            get
            {
                ...
                unsafe
                {
                    return *GpuInvoke.StereoBM_GPU_winSize(ptr);
                }
            }
            set
            {
                ...
                unsafe
                {
                    *GpuInvoke.StereoBM_GPU_winSize(ptr) = value;
                }
            }
        }
#if LANG_JP
        ...
        public float AvergeTexThreshold
        {
            get
            {
                ...
                unsafe
                {
                    return *GpuInvoke.StereoBM_GPU_avergeTexThreshold(ptr);
                }
            }
            set
            {
                ...
                unsafe
                {
                    *GpuInvoke.StereoBM_GPU_avergeTexThreshold(ptr) = value;
                }
            }
        }
        #endregion
