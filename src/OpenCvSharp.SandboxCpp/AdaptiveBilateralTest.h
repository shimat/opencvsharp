...
public:
	AdaptiveBilateralTest()
	{
		...
		//(2-1) RAW
		std::cout << "RAW: " << PSNR::calcPSNR(src, snoise) << std::endl << std::endl;
		cv::imwrite("C:\\temp\\noise.png", snoise);
		...
		std::cout << "gaussian: " << PSNR::calcPSNR(src, gaussian) << std::endl << std::endl;
		...
		std::cout << "time: " << 1000.0*(cv::getTickCount() - pre) / (cv::getTickFrequency()) << " ms" << std::endl;
		std::cout << "median: " << PSNR::calcPSNR(src, median) << std::endl << std::endl;
		...
		std::cout << "time: " << 1000.0*(cv::getTickCount() - pre) / (cv::getTickFrequency()) << " ms" << std::endl;
		std::cout << "bilateral: " << PSNR::calcPSNR(src, bilateral) << std::endl << std::endl;
		...
		std::cout << "time: " << 1000.0*(cv::getTickCount() - pre) / (cv::getTickFrequency()) << " ms" << std::endl;
		std::cout << "adaptiveBilateral: " << PSNR::calcPSNR(src, adaptive) << std::endl << std::endl;
