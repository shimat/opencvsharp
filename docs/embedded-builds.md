...
|--------|-------------|-------------|
| [build-opencvsharp-arm64.sh](../src/build-opencvsharp-arm64.sh) | Full build with all features and contrib modules | ~140MB |
| [build-opencvsharp-minimal-arm64.sh](../src/build-opencvsharp-minimal-arm64.sh) | Minimal build for basic camera capture | ~25MB |
...
cd ~
chmod +x ~/opencvsharp/src/build-opencvsharp-minimal-arm64.sh
~/opencvsharp/src/build-opencvsharp-minimal-arm64.sh
```
...
[A script to do the full-up build for linux-arm64 is available here](../src/build-opencvsharp-arm64.sh), but below are the manual instructions.
...
[A script to do a minimal build for linux-arm64 is available here](../src/build-opencvsharp-minimal-arm64.sh), but below are the manual instructions.
